...
class Seeder_roles extends Seeder
{
    public function run(): void
    {
        ...
        $rol1       = new Role();
        $rol1->name = 'Super Administrador';
        $rol1->save();

        $superadministrador_permiso = [
            'admin_usuario_menu',
        ...
        //para administador
        $rol2 = new Role();
        $rol2->name = 'Administrador';
        $rol2->save();

        /* $administrador_permiso = [
            'admin_usuario_menu',
            //para el menu usuario
            'usuario_submenu',
            'usuario_nuevo',
            ...
            //para el submenu de AMBITO PROFESIONAL
            'ambito_academico_submenu',
            'ambito_academico_nuevo',
            'ambito_academico_editar',
            'ambito_academico_eliminar',
            //para vizualizar de acuerdo al AMBITO PROFESIONAL
            'ambito_academico_vizualizar',
            'ambito_academico_vizualizar_profesion_nuevo',
            'ambito_academico_vizualizar_profesion_editar',
            'ambito_academico_vizualizar_profesion_eliminar',
            ...
            //submenu personas
            'persona_submenu',
            'persona_submenu_nuevo',
            'persona_submenu_editar',
            'persona_submenu_eliminar',
            'persona_submenu_listar_contratos',
            'persona_submenu_listar_contratos_estado',
            'persona_submenu_listar_contratos_modificatorio',
            'persona_submenu_listar_contratos_editar',
            'persona_submenu_listar_contratos_eliminar',
