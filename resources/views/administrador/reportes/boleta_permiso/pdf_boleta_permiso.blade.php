...
<head>
    ...
    <style>
        ...
        #estilo_dashed {
            border: 1px dashed rgba(130, 130, 130, 0.583);
        }
...
<body>
                    ...
                    <th style="width: 66.7%; margin: 10%" id="borde_borrar_table">
                        <table>
                            ...
                            <tr>
                                ...
                                <td style="border: none;"> : {{ $permiso->descripcion }}</td>
                            </tr>
                        </table>
    ...
    <img src="{{ $imagen_logo_gradiante }}" style="width: 100%; height: 5px; margin-top: 40px" />
                    ...
                    <th style="width: 66.7%; margin: 10%" id="borde_borrar_table">
                        <table>
                            ...
                            @if ($permiso->contrato->id_cargo_sm != null)
                                ...
                                <tr>
                                    <td id="borde_borrar_table"> CARGO</td>
                                    <td id="borde_borrar_table"> : {{ $permiso->contrato->cargo_sm->nombre }} Lorem
                                        ipsum dolor sit amet consectetur, adipisicing elit. Sed sunt fugit ipsa labore
                                        quidem quasi reprehenderit modi veniam illum, architecto ullam, quaerat, aliquid
                                        distinctio saepe dolorum molestiae perspiciatis eveniet explicabo! </td>
                                </tr>
                            @endif
                        ...
                        <table>
                            <thead>
                                <tr>
                                    <th id="border_abajo">FECHA SOLICITADA</th>
                                    <th id="border_abajo">FECHA DE INICIO Y HORA DE INICIO</th>
                                    <th id="border_abajo">FECHA DE INICIO Y HORA DE INICIO</th>
                                </tr>
                            </thead>
                            <tbody>
